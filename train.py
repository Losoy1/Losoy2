...
from Model import Transformer  # 导入新的模型
...
INIT_LR = 1e-3
BATCH = 8
IMAGE_DIMS = (64, 64, 3)  # width, height, depth
...
model = Transformer.build(width=IMAGE_DIMS[1], height=IMAGE_DIMS[0], depth=IMAGE_DIMS[2], classes=len(classes))
